...
export const Footer: React.FC = () => {
  return (
    <footer className="border-t border-slate-200 bg-white py-4 px-6 text-xs text-slate-500 select-none flex flex-col sm:flex-row items-center justify-between gap-3 mt-auto">
      ...
      <div className="flex items-center gap-1.5 font-medium">
        ...
        <a
          href="https://portfolio.ahmed-a-plus.dev"
          target="_blank"
