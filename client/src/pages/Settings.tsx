  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto text-right select-none">
      ...
      <div className="space-y-1">
        <h1 className="text-2xl font-bold text-slate-900">إعدادات النظام والبروفايل</h1>
        <p className="text-xs text-slate-500 font-medium">
          إدارة بياناتك الشخصية، تفضيلات التنبيهات، وحماية الحساب في مكان واحد.
        </p>
      </div>
        ...
        <form onSubmit={handleSaveSettings} className="space-y-6">
          ...
          <div className="flex justify-end pt-4 border-t border-slate-200">
            ...
            >
              ...
              <span>{isSaving ? 'جاري الحفظ...' : 'حفظ التغيرات والتفضيلات'}</span>
            </button>
          </div>
