...
export const CreateTask: React.FC = () => {
    ...
    const [status, setStatus] = useState<"todo" | "doing" | "review" | "done">(
        "todo",
    );
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await createTaskApi(selectedProjectId, {
                title: title.trim(),
                description:
                    description.trim() || "تفاصيل وخطوات التنفيذ المطلوبة...",
                status: status,
        ...
        <div className="space-y-6 max-w-6xl mx-auto text-right ">
            <div className="space-y-1">
                ...
                <p className="text-xs text-slate-500 font-medium">
                    حدد عناصر العمل وقم بإسنادها إلى أعضاء فريقك لمتابعة
                    التنفيذ.
                </p>
            </div>
