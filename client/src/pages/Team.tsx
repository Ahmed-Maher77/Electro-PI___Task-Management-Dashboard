...
export const Team: React.FC = () => {
  ...
  const [members] = useState<TeamMember[]>([
    ...
    {
      id: '3',
      name: 'ديفيد كيم (David Kim)',
      email: 'david.kim@electro-pi.com',
      role: 'مصمم المنتجات (Product Designer)',
      roleBadge: 'bg-slate-100 text-slate-600 border-slate-200',
      department: 'تصميم الواجهات',
      projectsCount: 4,
      status: 'active',
    },
    {
      id: '4',
      name: 'إيلينا فانس (Elena Vance)',
      email: 'elena.vance@electro-pi.com',
      role: 'مهندس سحابي رئيسي (Lead Cloud Engineer)',
      roleBadge: 'bg-blue-50 text-blue-600 border-blue-200',
      department: 'البنية التحتية',
      projectsCount: 6,
      status: 'active',
    ...
    {
      id: '5',
      name: 'أليكس كومار (Alex Kumar)',
      email: 'alex.kumar@electro-pi.com',
      role: 'مطور خلفية (Backend Developer)',
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto text-right select-none">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <button
          onClick={() => alert('تم فتح نافذة دعوة عضو جديد')}
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs">
        ...
        <div className="flex items-center gap-2 self-start sm:self-auto">
          ...
          >
            ...
            <option value="الأمان">الأمان والعمليات</option>
            <option value="تصميم">تصميم الواجهات</option>
      ...
      <div className="bg-white border border-slate-200 rounded-md overflow-hidden">
        ...
        <div className="bg-slate-50/50 border-t border-slate-200 p-4 text-xs text-slate-500 flex items-center justify-between">
          ...
          <span className="flex items-center gap-1">
            ...
            جميع الأعضاء محميون بسياسة الأمان المؤسسية
          </span>
        </div>
